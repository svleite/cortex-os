...
> Pra Meta Ads, Google Ads e GA4 a recomendacao e usar as skills da Córtex OS, que ja embrulham as APIs em comandos prontos com as melhores praticas (benchmarks BR, Quality Gates, Health Score). Listadas tambem em `templates/skills/catalogo.md`.
...
**Recomendacao:** Use a skill `/ga4-cortex` (ja vem com 13 subcomandos prontos: realtime, landing pages, conversoes, etc). Repo: github.com/svleite/ga4-cortex
...
**Recomendacao:** Use a skill `/meta-ads-cortex` (43 subcomandos cobrindo CRUD completo + targeting). Orquestrada por `/ads-cortex` quando precisar de diagnostico/relatorio. Repo: github.com/svleite/meta-ads-cortex
...
**Recomendacao:** Use a skill `/google-ads-cortex` (30 subcomandos: GAQL + CRUD + Quality Score + Keyword Planner). Orquestrada por `/ads-cortex` quando precisar de diagnostico/relatorio. Repo: github.com/svleite/google-ads-cortex
