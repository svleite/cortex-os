...
**Como instalar:** `git clone https://github.com/svleite/transcribe ~/.claude/skills/transcribe`
**Fonte:** Skill da Córtex OS, repo publico
...
**Como instalar:** `git clone https://github.com/svleite/ga4-cortex ~/.claude/skills/ga4-cortex`. Setup conversacional na primeira vez
**Fonte:** Skill da Córtex OS, repo publico

### Ads Córtex (cerebro orquestrador)
**O que faz:** Diagnostico, relatorio, auditoria e estrategia para Meta Ads e Google Ads. Usa benchmarks brasileiros, Quality Gates e Health Score. Orquestra `meta-ads-cortex`, `google-ads-cortex` e `ga4-cortex`.
**Bom pra:** Diagnostico de conta, relatorio de performance, auditoria de tragefo, identificar problemas de campanha
**Como instalar:** `git clone https://github.com/svleite/ads-cortex ~/.claude/skills/ads-cortex`
**Fonte:** Skill da Córtex OS, repo publico
...
**Como instalar:** `git clone https://github.com/svleite/meta-ads-cortex ~/.claude/skills/meta-ads-cortex`
**Fonte:** Skill da Córtex OS, repo publico
...
**Como instalar:** `git clone https://github.com/svleite/google-ads-cortex ~/.claude/skills/google-ads-cortex`
**Fonte:** Skill da Córtex OS, repo publico
