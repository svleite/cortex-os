...
- `~/.cortex-os/templates/skills/` — templates de skills prontos pra personalizar com /mapear
- `~/.cortex-os/templates/ferramentas/catalogo.md` — APIs e ferramentas disponíveis pra usar em skills
...
1. Verificar se existe um template relevante em `~/.cortex-os/templates/skills/`. Se existir, usar como base e adaptar pro contexto do usuário
...
Ler os templates de perfil disponíveis em `~/.cortex-os/templates/perfis/` pra saber quais opções existem. Depois apresentar:
...
Ler `~/.cortex-os/templates/ferramentas/catalogo.md` e cruzar com as ferramentas que o usuário citou na Pergunta 5.
